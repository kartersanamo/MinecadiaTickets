...
class AnalyticsLogger:
    ...
    @classmethod
    def record_ticket_message(cls, channel_id: str, *, is_staff: bool) -> None:
    ...
    @classmethod
    def record_command(cls, bot_id: str, command_name: str) -> None:
